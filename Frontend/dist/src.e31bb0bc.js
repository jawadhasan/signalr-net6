...
},{"@popperjs/core":"../node_modules/@popperjs/core/lib/index.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
exports.default = _default;
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"ajaxService.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = makeAjaxRequest;
...
async function sendMessage(logger, transportName, httpClient, url, content, options) {
  ...
  headers[name] = value;
  logger.log(_ILogger.LogLevel.Trace, `(${transportName} transport) sending data. ${getDataDetail(content, options.logMessageContent)}.`);
...
class ConsoleLogger {
  ...
  log(logLevel, message) {
    if (logLevel >= this._minLevel) {
      const msg = `[${new Date().toISOString()}] ${_ILogger.LogLevel[logLevel]}: ${message}`;
...
},{"./ILogger":"../node_modules/@microsoft/signalr/dist/esm/ILogger.js","./Loggers":"../node_modules/@microsoft/signalr/dist/esm/Loggers.js","process":"../node_modules/process/browser.js"}],"../node_modules/@microsoft/signalr/dist/esm/FetchHttpClient.js":[function(require,module,exports) {
"use strict";
...
// Licensed to the .NET Foundation under one or more agreements.
// The .NET Foundation licenses this file to you under the MIT license.
class FetchHttpClient extends _HttpClient.HttpClient {
  constructor(logger) {
    super();
    this._logger = logger;
    ...
    if (typeof fetch === "undefined") {
      ...
      this._fetchType = fetch.bind((0, _Utils.getGlobalThis)());
    }
  ...
  async send(request) {
    ...
    if (request.timeout) {
      ...
      timeoutId = setTimeout(() => {
        ...
        this._logger.log(_ILogger.LogLevel.Warning, `Timeout from HTTP request.`);
    ...
    if (request.content) {
      ...
      if ((0, _Utils.isArrayBuffer)(request.content)) {
    ...
    try {
      ...
      this._logger.log(_ILogger.LogLevel.Warning, `Error from HTTP request. ${e}.`);
    ...
    if (!response.ok) {
      ...
      throw new _Errors.HttpError(errorMessage || response.statusText, response.status);
    }

    const content = deserializeContent(response, request.responseType);
    const payload = await content;
    return new _HttpClient.HttpResponse(response.status, response.statusText, payload);
  }

  getCookieString(url) {
    let cookies = "";

    if (_Utils.Platform.isNode && this._jar) {
...
},{"./Errors":"../node_modules/@microsoft/signalr/dist/esm/Errors.js","./HttpClient":"../node_modules/@microsoft/signalr/dist/esm/HttpClient.js","./ILogger":"../node_modules/@microsoft/signalr/dist/esm/ILogger.js","./Utils":"../node_modules/@microsoft/signalr/dist/esm/Utils.js"}],"../node_modules/@microsoft/signalr/dist/esm/XhrHttpClient.js":[function(require,module,exports) {
"use strict";
...
// Licensed to the .NET Foundation under one or more agreements.
// The .NET Foundation licenses this file to you under the MIT license.
class XhrHttpClient extends _HttpClient.HttpClient {
  constructor(logger) {
    super();
    this._logger = logger;
  }
    ...
    return new Promise((resolve, reject) => {
      ...
      xhr.onload = () => {
        ...
        if (xhr.status >= 200 && xhr.status < 300) {
          ...
          reject(new _Errors.HttpError(xhr.response || xhr.responseText || xhr.statusText, xhr.status));
        }
      };

      xhr.onerror = () => {
        this._logger.log(_ILogger.LogLevel.Warning, `Error from HTTP request. ${xhr.status}: ${xhr.statusText}.`);
...
class DefaultHttpClient extends _HttpClient.HttpClient {
  /** Creates a new instance of the {@link @microsoft/signalr.DefaultHttpClient}, using the provided {@link @microsoft/signalr.ILogger} to log messages. */
  constructor(logger) {
    super();

    if (typeof fetch !== "undefined" || _Utils.Platform.isNode) {
      this._httpClient = new _FetchHttpClient.FetchHttpClient(logger);
    } else if (typeof XMLHttpRequest !== "undefined") {
      this._httpClient = new _XhrHttpClient.XhrHttpClient(logger);
    } else {
...
},{"./Errors":"../node_modules/@microsoft/signalr/dist/esm/Errors.js","./FetchHttpClient":"../node_modules/@microsoft/signalr/dist/esm/FetchHttpClient.js","./HttpClient":"../node_modules/@microsoft/signalr/dist/esm/HttpClient.js","./Utils":"../node_modules/@microsoft/signalr/dist/esm/Utils.js","./XhrHttpClient":"../node_modules/@microsoft/signalr/dist/esm/XhrHttpClient.js"}],"../node_modules/@microsoft/signalr/dist/esm/TextMessageFormat.js":[function(require,module,exports) {
"use strict";
...
class HandshakeProtocol {
  ...
  parseHandshakeResponse(data) {
    ...
    if ((0, _Utils.isArrayBuffer)(data)) {
      ...
      const separatorIndex = binaryData.indexOf(_TextMessageFormat.TextMessageFormat.RecordSeparatorCode);
      ...
      const textData = data;
      const separatorIndex = textData.indexOf(_TextMessageFormat.TextMessageFormat.RecordSeparator);
    ...
    const messages = _TextMessageFormat.TextMessageFormat.parse(messageData);
...
},{"./TextMessageFormat":"../node_modules/@microsoft/signalr/dist/esm/TextMessageFormat.js","./Utils":"../node_modules/@microsoft/signalr/dist/esm/Utils.js"}],"../node_modules/@microsoft/signalr/dist/esm/IHubProtocol.js":[function(require,module,exports) {
"use strict";
...
class HubConnection {
  constructor(connection, logger, protocol, reconnectPolicy) {
    ...
    this._freezeEventListener = () => {
      this._logger.log(_ILogger.LogLevel.Warning, "The page is being frozen, this will likely lead to the connection being closed and messages being lost. For more information see the docs at https://docs.microsoft.com/aspnet/core/signalr/javascript-client#bsleep");
    };
    ...
    this._handshakeProtocol = new _HandshakeProtocol.HandshakeProtocol();
  ...
  async _startWithStateTransitions() {
    ...
    this._logger.log(_ILogger.LogLevel.Debug, "Starting HubConnection.");

    try {
      await this._startInternal();

      if (_Utils.Platform.isBrowser) {
      ...
      this._logger.log(_ILogger.LogLevel.Debug, "HubConnection connected successfully.");
    } catch (e) {
      this._connectionState = HubConnectionState.Disconnected;

      this._logger.log(_ILogger.LogLevel.Debug, `HubConnection failed to start successfully because of error '${e}'.`);
  ...
  async _startInternal() {
    ...
    try {
      ...
      this._logger.log(_ILogger.LogLevel.Debug, "Sending handshake request.");

      await this._sendMessage(this._handshakeProtocol.writeHandshakeRequest(handshakeRequest));

      this._logger.log(_ILogger.LogLevel.Information, `Using HubProtocol '${this._protocol.name}'.`); // defensively cleanup timeout in case we receive a message from the server before we finish start
      ...
      this._logger.log(_ILogger.LogLevel.Debug, `Hub handshake failed with error '${e}' during start(). Stopping HubConnection.`);
  ...
  _stopInternal(error) {
    if (this._connectionState === HubConnectionState.Disconnected) {
      this._logger.log(_ILogger.LogLevel.Debug, `Call to HubConnection.stop(${error}) ignored because it is already in the disconnected state.`);

      return Promise.resolve();
    }

    if (this._connectionState === HubConnectionState.Disconnecting) {
      this._logger.log(_ILogger.LogLevel.Debug, `Call to HttpConnection.stop(${error}) ignored because the connection is already in the disconnecting state.`);
    ...
    this._logger.log(_ILogger.LogLevel.Debug, "Stopping HubConnection.");

    if (this._reconnectDelayHandle) {
      // We're in a reconnect delay which means the underlying connection is currently already stopped.
      // Just clear the handle to stop the reconnect loop (which no one is waiting on thankfully) and
      // fire the onclose callbacks.
      this._logger.log(_ILogger.LogLevel.Debug, "Connection stopped during reconnect delay. Done reconnecting.");
    ...
    this._stopDuringStartError = error || new _Errors.AbortError("The connection was stopped before the hub handshake could complete."); // HttpConnection.stop() should not complete until after either HttpConnection.start() fails
      ...
      for (const message of messages) {
        switch (message.type) {
          ...
          case _IHubProtocol.MessageType.Completion:
            {
              ...
              if (callback) {
                ...
                try {
                  ...
                  this._logger.log(_ILogger.LogLevel.Error, `Stream callback threw error: ${(0, _Utils.getErrorString)(e)}`);
                }
              }
          ...
          case _IHubProtocol.MessageType.Close:
            {
              this._logger.log(_ILogger.LogLevel.Information, "Close message received from server.");
          ...
          default:
            this._logger.log(_ILogger.LogLevel.Warning, `Invalid message type: ${message.type}.`);
  ...
  _processHandshakeResponse(data) {
    ...
    try {
      ...
      this._logger.log(_ILogger.LogLevel.Error, message);
    ...
    if (responseMessage.error) {
      ...
      this._logger.log(_ILogger.LogLevel.Debug, "Server handshake complete.");
    }
  ...
  async _invokeClientMethod(invocationMessage) {
    ...
    if (!methods) {
      this._logger.log(_ILogger.LogLevel.Warning, `No client method with the name '${methodName}' found.`); // No handlers provided by client but the server is expecting a response still, so we send an error


      if (invocationMessage.invocationId) {
        this._logger.log(_ILogger.LogLevel.Warning, `No result given for '${methodName}' method and invocation ID '${invocationMessage.invocationId}'.`);
    ...
    for (const m of methodsCopy) {
      try {
        ...
        if (expectsResponse && res && prevRes) {
          this._logger.log(_ILogger.LogLevel.Error, `Multiple results provided for '${methodName}'. Sending error to server.`);
        ...
        this._logger.log(_ILogger.LogLevel.Error, `A callback for the method '${methodName}' threw error '${e}'.`);
      }
    }
    ...
    if (completionMessage) {
      ...
      if (exception) {
        ...
        this._logger.log(_ILogger.LogLevel.Warning, `No result given for '${methodName}' method and invocation ID '${invocationMessage.invocationId}'.`); // Client didn't provide a result or throw from a handler, server expects a response so we send an error
      ...
      if (res) {
        this._logger.log(_ILogger.LogLevel.Error, `Result given for '${methodName}' method but server is not expecting a result.`);
      }
    }
  }

  _connectionClosed(error) {
    this._logger.log(_ILogger.LogLevel.Debug, `HubConnection.connectionClosed(${error}) called while in state ${this._connectionState}.`); // Triggering this.handshakeRejecter is insufficient because it could already be resolved without the continuation having run yet.


    this._stopDuringStartError = this._stopDuringStartError || error || new _Errors.AbortError("The underlying connection was closed before the hub handshake could complete."); // If the handshake is in progress, start will be waiting for the handshake promise, so we complete it.
  ...
  _completeClose(error) {
    if (this._connectionStarted) {
      ...
      try {
        ...
        this._logger.log(_ILogger.LogLevel.Error, `An onclose callback called with error '${error}' threw error '${e}'.`);
      }
    }
  }
  ...
  async _reconnect(error) {
    ...
    if (nextRetryDelay === null) {
      this._logger.log(_ILogger.LogLevel.Debug, "Connection not reconnecting because the IRetryPolicy returned null on the first reconnect attempt.");
    ...
    if (error) {
      this._logger.log(_ILogger.LogLevel.Information, `Connection reconnecting because of error '${error}'.`);
    } else {
      this._logger.log(_ILogger.LogLevel.Information, "Connection reconnecting.");
    }
    ...
    if (this._reconnectingCallbacks.length !== 0) {
      try {
        ...
        this._logger.log(_ILogger.LogLevel.Error, `An onreconnecting callback called with error '${error}' threw error '${e}'.`);
      } // Exit early if an onreconnecting callback called connection.stop().


      if (this._connectionState !== HubConnectionState.Reconnecting) {
        this._logger.log(_ILogger.LogLevel.Debug, "Connection left the reconnecting state in onreconnecting callback. Done reconnecting.");
    ...
    while (nextRetryDelay !== null) {
      this._logger.log(_ILogger.LogLevel.Information, `Reconnect attempt number ${previousReconnectAttempts} will start in ${nextRetryDelay} ms.`);
      ...
      if (this._connectionState !== HubConnectionState.Reconnecting) {
        this._logger.log(_ILogger.LogLevel.Debug, "Connection left the reconnecting state during reconnect delay. Done reconnecting.");
      ...
      try {
        ...
        this._logger.log(_ILogger.LogLevel.Information, "HubConnection reconnected successfully.");

        if (this._reconnectedCallbacks.length !== 0) {
          try {
            this._reconnectedCallbacks.forEach(c => c.apply(this, [this.connection.connectionId]));
          } catch (e) {
            this._logger.log(_ILogger.LogLevel.Error, `An onreconnected callback called with connectionId '${this.connection.connectionId}; threw error '${e}'.`);
          }
        }

        return;
      } catch (e) {
        this._logger.log(_ILogger.LogLevel.Information, `Reconnect attempt failed because of error '${e}'.`);

        if (this._connectionState !== HubConnectionState.Reconnecting) {
          this._logger.log(_ILogger.LogLevel.Debug, `Connection moved to the '${this._connectionState}' from the reconnecting state during reconnect attempt. Done reconnecting.`); // The TypeScript compiler thinks that connectionState must be Connected here. The TypeScript compiler is wrong.
    ...
    this._logger.log(_ILogger.LogLevel.Information, `Reconnect retries have been exhausted after ${Date.now() - reconnectStartTime} ms and ${previousReconnectAttempts} failed attempts. Connection disconnecting.`);
  ...
  _getNextRetryDelay(previousRetryCount, elapsedMilliseconds, retryReason) {
    try {
      ...
      this._logger.log(_ILogger.LogLevel.Error, `IRetryPolicy.nextRetryDelayInMilliseconds(${previousRetryCount}, ${elapsedMilliseconds}) threw error '${e}'.`);
  ...
  _cancelCallbacksWithError(error) {
    ...
    Object.keys(callbacks).forEach(key => {
      ...
      try {
        ...
        this._logger.log(_ILogger.LogLevel.Error, `Stream 'error' callback called with '${error}' threw error: ${(0, _Utils.getErrorString)(e)}`);
      }
    });
  }
...
},{}],"../node_modules/@microsoft/signalr/dist/esm/HeaderNames.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/@microsoft/signalr/dist/esm/AccessTokenHttpClient.js":[function(require,module,exports) {
"use strict";
...
/** @private */
class AccessTokenHttpClient extends _HttpClient.HttpClient {
  ...
  _setAuthorizationHeader(request) {
    ...
    if (this._accessToken) {
      request.headers[_HeaderNames.HeaderNames.Authorization] = `Bearer ${this._accessToken}`;
    } // don't remove the header if there isn't an access token factory, the user manually added the header in this case
    else if (this._accessTokenFactory) {
      if (request.headers[_HeaderNames.HeaderNames.Authorization]) {
        delete request.headers[_HeaderNames.HeaderNames.Authorization];
      }
    }
  }
...
},{"./HeaderNames":"../node_modules/@microsoft/signalr/dist/esm/HeaderNames.js","./HttpClient":"../node_modules/@microsoft/signalr/dist/esm/HttpClient.js"}],"../node_modules/@microsoft/signalr/dist/esm/ITransport.js":[function(require,module,exports) {
"use strict";
...
class LongPollingTransport {
  constructor(httpClient, logger, options) {
    ...
    this._logger = logger;
    this._pollAbort = new _AbortController.AbortController();
  ...
  async connect(url, transferFormat) {
    ...
    this._logger.log(_ILogger.LogLevel.Trace, "(LongPolling transport) Connecting."); // Allow binary format on Node and Browsers that support binary content (indicated by the presence of responseType property)
    ...
    this._logger.log(_ILogger.LogLevel.Trace, `(LongPolling transport) polling: ${pollUrl}.`);

    const response = await this._httpClient.get(pollUrl, pollOptions);

    if (response.statusCode !== 200) {
      this._logger.log(_ILogger.LogLevel.Error, `(LongPolling transport) Unexpected response code: ${response.statusCode}.`); // Mark running as false so that the poll immediately ends and runs the close logic


      this._closeError = new _Errors.HttpError(response.statusText || "", response.statusCode);
      this._running = false;
    } else {
      this._running = true;
    }
  ...
  async _poll(url, pollOptions) {
    try {
      while (this._running) {
        try {
          ...
          if (response.statusCode === 204) {
            this._logger.log(_ILogger.LogLevel.Information, "(LongPolling transport) Poll terminated by server.");

            this._running = false;
          } else if (response.statusCode !== 200) {
            this._logger.log(_ILogger.LogLevel.Error, `(LongPolling transport) Unexpected response code: ${response.statusCode}.`); // Unexpected status code
            ...
            if (response.content) {
              this._logger.log(_ILogger.LogLevel.Trace, `(LongPolling transport) data received. ${(0, _Utils.getDataDetail)(response.content, this._options.logMessageContent)}.`);
              ...
              this._logger.log(_ILogger.LogLevel.Trace, "(LongPolling transport) Poll timed out, reissuing.");
            }
          }
        } catch (e) {
          if (!this._running) {
            // Log but disregard errors that occur after stopping
            this._logger.log(_ILogger.LogLevel.Trace, `(LongPolling transport) Poll errored after shutdown: ${e.message}`);
          } else {
      ...
      this._logger.log(_ILogger.LogLevel.Trace, "(LongPolling transport) Polling complete."); // We will reach here with pollAborted==false when the server returned a response causing the transport to stop.
  ...
  async send(data) {
    ...
    return (0, _Utils.sendMessage)(this._logger, "LongPolling", this._httpClient, this._url, data, this._options);
  }

  async stop() {
    this._logger.log(_ILogger.LogLevel.Trace, "(LongPolling transport) Stopping polling."); // Tell receiving loop to stop, abort any current request, and then wait for it to finish
    ...
    try {
      ...
      this._logger.log(_ILogger.LogLevel.Trace, `(LongPolling transport) sending DELETE request to ${this._url}.`);
      ...
      this._logger.log(_ILogger.LogLevel.Trace, "(LongPolling transport) DELETE request sent.");
    } finally {
      this._logger.log(_ILogger.LogLevel.Trace, "(LongPolling transport) Stop finished."); // Raise close event here instead of in polling
  ...
  _raiseOnClose() {
    if (this.onclose) {
      ...
      this._logger.log(_ILogger.LogLevel.Trace, logMessage);
...
class ServerSentEventsTransport {
  ...
  async connect(url, transferFormat) {
    ...
    this._logger.log(_ILogger.LogLevel.Trace, "(SSE transport) Connecting."); // set url before accessTokenFactory because this._url is only for send and we set the auth header instead of the query string for send
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        eventSource.onmessage = e => {
          if (this.onreceive) {
            try {
              this._logger.log(_ILogger.LogLevel.Trace, `(SSE transport) data received. ${(0, _Utils.getDataDetail)(e.data, this._options.logMessageContent)}.`);
        ...
        eventSource.onopen = () => {
          this._logger.log(_ILogger.LogLevel.Information, `SSE connected to ${this._url}`);
  ...
  async send(data) {
    ...
    return (0, _Utils.sendMessage)(this._logger, "SSE", this._httpClient, this._url, data, this._options);
  }
...
class WebSocketTransport {
  ...
  async connect(url, transferFormat) {
    ...
    this._logger.log(_ILogger.LogLevel.Trace, "(WebSockets transport) Connecting.");
    ...
    return new Promise((resolve, reject) => {
      ...
      if (_Utils.Platform.isNode || _Utils.Platform.isReactNative) {
        const headers = {};
        const [name, value] = (0, _Utils.getUserAgentHeader)();
        headers[name] = value;

        if (token) {
          headers[_HeaderNames.HeaderNames.Authorization] = `Bearer ${token}`;
        }

        if (cookies) {
          headers[_HeaderNames.HeaderNames.Cookie] = cookies;
      ...
      webSocket.onopen = _event => {
        this._logger.log(_ILogger.LogLevel.Information, `WebSocket connected to ${url}.`);
      ...
      webSocket.onerror = event => {
        ...
        this._logger.log(_ILogger.LogLevel.Information, `(WebSockets transport) ${error}.`);
      };

      webSocket.onmessage = message => {
        this._logger.log(_ILogger.LogLevel.Trace, `(WebSockets transport) data received. ${(0, _Utils.getDataDetail)(message.data, this._logMessageContent)}.`);
  ...
  send(data) {
    if (this._webSocket && this._webSocket.readyState === this._webSocketConstructor.OPEN) {
      this._logger.log(_ILogger.LogLevel.Trace, `(WebSockets transport) sending data. ${(0, _Utils.getDataDetail)(data, this._logMessageContent)}.`);
  ...
  _close(event) {
    ...
    this._logger.log(_ILogger.LogLevel.Trace, "(WebSockets transport) socket closed.");
...
},{"./HeaderNames":"../node_modules/@microsoft/signalr/dist/esm/HeaderNames.js","./ILogger":"../node_modules/@microsoft/signalr/dist/esm/ILogger.js","./ITransport":"../node_modules/@microsoft/signalr/dist/esm/ITransport.js","./Utils":"../node_modules/@microsoft/signalr/dist/esm/Utils.js"}],"../node_modules/@microsoft/signalr/dist/esm/HttpConnection.js":[function(require,module,exports) {
"use strict";
...
var _AccessTokenHttpClient = require("./AccessTokenHttpClient");
...
class HttpConnection {
  constructor(url, options = {}) {
    ...
    this._httpClient = new _AccessTokenHttpClient.AccessTokenHttpClient(options.httpClient || new _DefaultHttpClient.DefaultHttpClient(this._logger), options.accessTokenFactory);
  ...
  async start(transferFormat) {
    ...
    this._logger.log(_ILogger.LogLevel.Debug, `Starting connection with transfer format '${_ITransport.TransferFormat[transferFormat]}'.`);
    ...
    /* Disconnecting */
      ...
      this._logger.log(_ILogger.LogLevel.Error, message); // We cannot await stopPromise inside startInternal since stopInternal awaits the startInternalPromise.


      await this._stopPromise;
      return Promise.reject(new _Errors.AbortError(message));
  ...
  async stop(error) {
    ...
    /* Disconnected */
      ...
      this._logger.log(_ILogger.LogLevel.Debug, `Call to HttpConnection.stop(${error}) ignored because the connection is already in the disconnected state.`);
  ...
  async _stopInternal(error) {
    ...
    if (this.transport) {
      try {
        ...
        this._logger.log(_ILogger.LogLevel.Error, `HttpConnection.transport.stop() threw error '${e}'.`);
      ...
      this._logger.log(_ILogger.LogLevel.Debug, "HttpConnection.transport is undefined in HttpConnection.stop() because start() failed.");
    }
  }
  ...
  async _startInternal(transferFormat) {
    ...
    try {
      if (this._options.skipNegotiation) {
        if (this._options.transport === _ITransport.HttpTransportType.WebSockets) {
          // No need to add a connection ID in this case
          this.transport = this._constructTransport(_ITransport.HttpTransportType.WebSockets); // We should just call connect directly in this case.
        ...
        do {
          ...
          /* Disconnected */
            ...
            throw new _Errors.AbortError("The connection was stopped during negotiation.");
          }
          ...
          if (negotiateResponse.accessToken) {
            ...
            this._accessTokenFactory = () => accessToken; // set the factory to undefined so the AccessTokenHttpClient won't retry with the same token, since we know it won't change until a connection restart
      ...
      /* Connecting */
        ...
        this._logger.log(_ILogger.LogLevel.Debug, "The HttpConnection connected successfully.");
      ...
      this._logger.log(_ILogger.LogLevel.Error, "Failed to start the connection: " + e);
  ...
  async _getNegotiationResponse(url) {
    ...
    this._logger.log(_ILogger.LogLevel.Debug, `Sending negotiation request: ${negotiateUrl}.`);
    ...
    try {
      ...
      if (e instanceof _Errors.HttpError) {
        if (e.statusCode === 404) {
          errorMessage = errorMessage + " Either this is not a SignalR endpoint or there is a proxy blocking the connection.";
        }
      }

      this._logger.log(_ILogger.LogLevel.Error, errorMessage);

      return Promise.reject(new _Errors.FailedToNegotiateWithServerError(errorMessage));
    }
  }
  ...
  async _createTransport(url, requestedTransport, negotiateResponse, requestedTransferFormat) {
    ...
    if (this._isITransport(requestedTransport)) {
      this._logger.log(_ILogger.LogLevel.Debug, "Connection was provided an instance of ITransport, using that directly.");
    ...
    for (const endpoint of transports) {
      ...
      if (transportOrError instanceof Error) {
        ...
        try {
          ...
          this._logger.log(_ILogger.LogLevel.Error, `Failed to start the transport '${endpoint.transport}': ${ex}`);

          negotiate = undefined;
          transportExceptions.push(new _Errors.FailedToStartTransportError(`${endpoint.transport} failed: ${ex}`, _ITransport.HttpTransportType[endpoint.transport]));
          ...
          /* Connecting */
            ...
            this._logger.log(_ILogger.LogLevel.Debug, message);
    ...
    if (transportExceptions.length > 0) {
      return Promise.reject(new _Errors.AggregateErrors(`Unable to connect to the server with any of the available transports. ${transportExceptions.join(" ")}`, transportExceptions));
    }
  ...
  _constructTransport(transport) {
    switch (transport) {
      case _ITransport.HttpTransportType.WebSockets:
        ...
        return new _WebSocketTransport.WebSocketTransport(this._httpClient, this._accessTokenFactory, this._logger, this._options.logMessageContent, this._options.WebSocket, this._options.headers || {});
      ...
      case _ITransport.HttpTransportType.ServerSentEvents:
        ...
        return new _ServerSentEventsTransport.ServerSentEventsTransport(this._httpClient, this._httpClient._accessToken, this._logger, this._options);

      case _ITransport.HttpTransportType.LongPolling:
        return new _LongPollingTransport.LongPollingTransport(this._httpClient, this._logger, this._options);
  ...
  _resolveTransportOrError(endpoint, requestedTransport, requestedTransferFormat) {
    const transport = _ITransport.HttpTransportType[endpoint.transport];

    if (transport === null || transport === undefined) {
      this._logger.log(_ILogger.LogLevel.Debug, `Skipping transport '${endpoint.transport}' because it is not supported by this client.`);

      return new Error(`Skipping transport '${endpoint.transport}' because it is not supported by this client.`);
    } else {
      if (transportMatches(requestedTransport, transport)) {
        const transferFormats = endpoint.transferFormats.map(s => _ITransport.TransferFormat[s]);

        if (transferFormats.indexOf(requestedTransferFormat) >= 0) {
          if (transport === _ITransport.HttpTransportType.WebSockets && !this._options.WebSocket || transport === _ITransport.HttpTransportType.ServerSentEvents && !this._options.EventSource) {
            this._logger.log(_ILogger.LogLevel.Debug, `Skipping transport '${_ITransport.HttpTransportType[transport]}' because it is not supported in your environment.'`);

            return new _Errors.UnsupportedTransportError(`'${_ITransport.HttpTransportType[transport]}' is not supported in your environment.`, transport);
          } else {
            this._logger.log(_ILogger.LogLevel.Debug, `Selecting transport '${_ITransport.HttpTransportType[transport]}'.`);
          ...
          this._logger.log(_ILogger.LogLevel.Debug, `Skipping transport '${_ITransport.HttpTransportType[transport]}' because it does not support the requested transfer format '${_ITransport.TransferFormat[requestedTransferFormat]}'.`);
        ...
        this._logger.log(_ILogger.LogLevel.Debug, `Skipping transport '${_ITransport.HttpTransportType[transport]}' because it was disabled by the client.`);

        return new _Errors.DisabledTransportError(`'${_ITransport.HttpTransportType[transport]}' is disabled by the client.`, transport);
      }
    }
  }
  ...
  _stopConnection(error) {
    this._logger.log(_ILogger.LogLevel.Debug, `HttpConnection.stopConnection(${error}) called while in state ${this._connectionState}.`);
    ...
    /* Disconnected */
      ...
      this._logger.log(_ILogger.LogLevel.Debug, `Call to HttpConnection.stopConnection(${error}) was ignored because the connection is already in the disconnected state.`);
    ...
    /* Connecting */
      ...
      this._logger.log(_ILogger.LogLevel.Warning, `Call to HttpConnection.stopConnection(${error}) was ignored because the connection is still in the connecting state.`);
    ...
    if (error) {
      this._logger.log(_ILogger.LogLevel.Error, `Connection disconnected with error '${error}'.`);
    } else {
      this._logger.log(_ILogger.LogLevel.Information, "Connection disconnected.");
    }

    if (this._sendQueue) {
      this._sendQueue.stop().catch(e => {
        this._logger.log(_ILogger.LogLevel.Error, `TransportSendQueue.stop() threw error '${e}'.`);
      });
    ...
    if (this._connectionStarted) {
      ...
      try {
        ...
        this._logger.log(_ILogger.LogLevel.Error, `HttpConnection.onclose(${error}) threw error '${e}'.`);
      }
    }
  }
  ...
  _resolveUrl(url) {
    ...
    this._logger.log(_ILogger.LogLevel.Information, `Normalizing '${url}' to '${aTag.href}'.`);
...
class JsonHubProtocol {
  ...
  parseMessages(input, logger) {
    ...
    const messages = _TextMessageFormat.TextMessageFormat.parse(input);
...
class HubConnectionBuilder {
  ...
  build() {
    ...
    const connection = new _HttpConnection.HttpConnection(this.url, httpConnectionOptions);
...
require("./resources/bootstrap.pulse.min");

require("./import-jquery.js");

var _ajaxService = _interopRequireDefault(require("./ajaxService.js"));
...
var DemoApp = /*#__PURE__*/function () {
  function DemoApp() {
    ...
    var self = this;
    this.vm = {
      title: _knockout.default.observable('Devices')
    };
    this.connection = new signalR.HubConnectionBuilder().withUrl("http://localhost:5229/productHub").configureLogging(signalR.LogLevel.Information).build();
    this.connection.onclose( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    this.connection.on("methodOnClient", function (data) {
      self.handleMethodOnClient(data);
    });
    this.connection.start(function () {
      console.log("connection started.");
    }).then(function () {
      return _this.connection.invoke("SendMessageToAll", "hello-FromBrowser");
    });
  }

  _createClass(DemoApp, [{
    key: "handleMethodOnClient",
    value: function handleMethodOnClient(msg) {
      console.log("method handler on DemoApp.".concat(msg));
    }
  }]);
...
$(function () {
  ...
  var elem = document.getElementById("indexPage");
  var demoApp = new DemoApp();

  _knockout.default.applyBindings(demoApp.vm, elem); //btn event wiring
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","bootstrap":"../node_modules/bootstrap/dist/js/bootstrap.esm.js","bootstrap/dist/css/bootstrap.css":"../node_modules/bootstrap/dist/css/bootstrap.css","@fortawesome/fontawesome-free/css/all.css":"../node_modules/@fortawesome/fontawesome-free/css/all.css","./resources/bootstrap.pulse.min":"resources/bootstrap.pulse.min.css","./import-jquery.js":"import-jquery.js","./ajaxService.js":"ajaxService.js","knockout":"../node_modules/knockout/build/output/knockout-latest.js","@microsoft/signalr":"../node_modules/@microsoft/signalr/dist/esm/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
